"""
Training script for LSTM-Small using PyTorch.
...
class LSTMLanguageModel(nn.Module):
    """LSTM language model with GPT-2 BPE tokenizer."""
...
def main():
    ...
    # Create LSTM model
    print("Creating LSTM-Small model...")
            ...
            if step % args.eval_interval == 0:
                ...
                if step % args.save_interval == 0:
                    checkpoint_path = os.path.join(
                        args.checkpoint_dir,
                        f'lstm_seed{args.seed}_step{step}.pt'
                    )
                    torch.save({
                        'step': step,
